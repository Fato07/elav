...
import { SessionTabs, SessionSidebar, UsageBadge } from "@/components/sessions";
  ...
  return (
    <div className="w-full flex justify-center items-center h-dvh overflow-hidden p-2 sm:p-4 md:p-8 md:pb-10">
      ...
      >
        ...
        <div className="border-b w-full px-2 sm:px-3 py-2 flex items-center justify-between h-auto">
          <div className="flex flex-1 items-center text-base sm:text-lg truncate">
            ...
            >
              ...
              <h1 className="whitespace-pre">ELAV Computer by </h1>
            </Link>
            <Link
              href="https://elav.ai"
          ...
          <div className="hidden lg:flex items-center gap-2">
            <Select
              value={provider}
              onValueChange={(value: ModelProvider) => setProvider(value)}
            >
        ...
        {/* Session tabs (visible when multiple sessions) */}
        <SessionTabs />
