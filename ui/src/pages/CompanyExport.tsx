...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("This is an [Agent Company](https://elav.ai) package.");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [ELAV](https://elav.ai) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [ELAV](https://elav.ai) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
