...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    ...
    description: "Reference UI plugin that adds a simple Hello World widget to the ELAV dashboard.",
  ...
  },
  {
    ...
    description: "Reference plugin that demonstrates the current ELAV plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
